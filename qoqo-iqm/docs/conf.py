...
man_pages = [(master_doc, "qoqo-iqm", "qoqo-iqm Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "qoqo-iqm",
        "HQS Quantum Simulations package for circuit conversions/transformations.",
        "Miscellaneous",
    ),
]
