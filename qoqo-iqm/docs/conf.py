...
latex_documents = [
    (master_doc, 'qoqo_iqm.tex', 'qoqo_iqm Documentation',
...
man_pages = [
    (master_doc, 'qoqo_iqm', 'qoqo_iqm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qoqo_iqm', 'qoqo_iqm Documentation',
     author, 'qoqo_iqm', 'IQM backend for qoqo quantum computing toolkit.',
     'Miscellaneous'),
]
